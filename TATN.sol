...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b)internal pure returns(uint256) {
        ...
        // benefit is lost if 'b' is also tested. See:
...
contract Ownable {
    ...
    function transferOwnership(address newOwner) onlyOwner public {
        require(newOwner != address(0), "transfer erorr ");
...
contract BasicToken is ERC20Basic {
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        require(_to != address(0) && _to != address(this), "transfer error");
...
contract BurnableToken is StandardToken {
    ...
    function burn(uint256 _value) public {
        ...
        require(_value <= balances[msg.sender], "Invalid value_");
...
contract MintableToken is StandardToken {
    ...
    function mint(uint256 _value) public {
        require(_value > 0, "value less than 0");
        require(_value <= balances[msg.sender], "invalid value");
        // no need to require value <= totalSupply, since that would imply the
        // sender's balance is greater than the totalSupply, which *should* be an assertion failure
